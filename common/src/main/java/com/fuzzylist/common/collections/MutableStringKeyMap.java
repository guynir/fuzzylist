 ...
 * The key is case-insensitive, which means that {@code key} and {@code KEY} are conisdered the same.
 *
 * <pre>
 *     MutableStringKeyMap map = new MutableStringKeyMap();
 *
...
public class MutableStringKeyMap implements ReadOnlyMap<String> {
     ...
     * @throws TypeMismatchException    If object cannot be casted to type <i>T</i>.
     * @throws IllegalArgumentException If <i>key</i> is {@code null}.
     */
    @Override
     ...
     * @throws TypeMismatchException    If type could not be converted to {@code Number}.

 ...
 * <ul>
 * <li>
 * {@link SecureRandomIdGenerator#setSymbols(char[])} (char[]) symbols} - Define table of characters that are used
 * for representing the generated identifier. Default configuration uses A-Z, a-z, 0-9 (62 characters).
 * </li>
 * <li>
 * {@link SecureRandomIdGenerator#setLength(int)} (int) length} - Define now many digits should be the generated
 * value. Default is 64 characters.
 * </li>
 * </ul>
...
public class SecureRandomIdGenerator implements IdGenerator {
     ...
     */
    private int length = DEFAULT_IDENTIFIER_LENGTH;

    /**
     * List of symbols to use for generating string-based identifier.
     */
    private char[] symbols = DEFAULT_SYMBOL_SET.toCharArray();
     ...
     * Class constructor.
     * <p>
     * Creates a new security random generator using default {@link #DEFAULT_IDENTIFIER_LENGTH length} and
     * {@link #DEFAULT_SYMBOL_SET symbols set}.
     */
    ...
    public void setSymbols(char[] symbols) {
        ...
        Assert.isTrue(symbols.length > 1, "Symbols list must contain at least 2 symbols.");
        this.symbols = symbols;
    }
